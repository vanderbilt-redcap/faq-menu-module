...
$dictionary_array = array (
    ...
    'E' => array ( 2 => 'Record ID', 3 =>"<div style=\"color:black; text-align:center; border: 1px #d35400; background-color: #e67e22; padding:6px; max-width:800px;\">Show this FAQ Item?</div>",
                    ...
                    7 => 'Supporting Image <div style="font-weight:lighter;font-style:italic">Optional image to be displayed below the answer text.</div>',
                    8 => 'Choose Video Format <div style="font-weight:lighter;font-style:italic">Optional video to be displayed below the answer text.</div>',
                    9 => 'Supporting Video Link <div style="font-weight:lighter;font-style:italic">Link to hosted video. The FAQ Builder will add the necessary iframe code.</div>',
                    10 => 'Video Embed Code <div style="font-weight:lighter;font-style:italic">HTML iframe code generated by website (e.g., Youtube)</div>' ) ,
    'F' => array ( 2 =>'', 3 =>'', 4 => "3, Protocol | 1, Study Clarifications | 2, Data Quality | 4, Invoicing | 5, Accounts and Login | 99, Harmonist Project", 5 =>'', 6 =>'', 7 => '',8 => "1, Video URL | 2, Video embed code / HTML (e.g., Youtube)", 9 =>'', 10 =>'' ),
